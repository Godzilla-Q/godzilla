...
def main():
    """calculate parameters for all sequences variations, print them sorted by their temperature reactivity"""
    structure = '(((......)))'
    results = []
    for sequence in combinations(3, 6):
        energy, entropy, enthalpy = temperature_reactivity(sequence, structure, 30, 37)
